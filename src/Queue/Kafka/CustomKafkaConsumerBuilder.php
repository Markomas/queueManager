...
namespace Markom\QueueManagerBundle\Queue\Kafka;
...
final class CustomKafkaConsumerBuilder implements KafkaConsumerBuilderInterface
{
     ...
     */
    private $decoder;
    private RdKafkaLowLevelConsumer|RdKafkaHighLevelConsumer $rdKafkaConsumer;
    ...
    public function build(): KafkaConsumerInterface
    {
        ...
        if (self::CONSUMER_TYPE_LOW_LEVEL === $this->consumerType) {
            ...
            $this->rdKafkaConsumer = new RdKafkaLowLevelConsumer($kafkaConfig);
        ...
        $this->rdKafkaConsumer = new RdKafkaHighLevelConsumer($kafkaConfig);

        return new KafkaHighLevelConsumer($this->rdKafkaConsumer, $kafkaConfig, $this->decoder);
    }
    ...
    /**
     * @return RdKafkaLowLevelConsumer|RdKafkaHighLevelConsumer
     */
    public function getRdKafkaConsumer(): RdKafkaHighLevelConsumer|RdKafkaLowLevelConsumer
    {
